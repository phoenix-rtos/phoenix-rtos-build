...
class ColorFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        return f"{self.COLORS.get(record.levelno, Color.DEFAULT).value}{self.extra_info(record)}{message}{Color.ENDC.value}"
...
def parse_args():
    ...
    parser.add_argument("-v", "--verbose", action="store_true", help="Enable verbose output (info and errors)")
