...
class ColorFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        return f"{self.COLORS.get(record.levelno, Color.DEFAULT).value}{message}{self.ENDC}"
...
def parse_args() -> tuple[argparse.Namespace, HeaderParams]:
    ...
    parser.add_argument("-v", "--verbose", action="store_true", help="Enable info and error otput")
